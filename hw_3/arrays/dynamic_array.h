...
/*! Return a sub-array of n elements. If the argument positive, it takes from the beginning. If it /*   is negative it takes from the end. If there are not enough elements, the method should return   *   as many as it can, and set the rest to zero. For example:
 *  \param a The array
 *  \param n The number of elements for sub-array
 */
